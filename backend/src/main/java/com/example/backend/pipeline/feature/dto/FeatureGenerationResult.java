...
public class FeatureGenerationResult {
    ...
    private String requestSpecification;   // compact JSON of requestBody map
    private String responseSpecification;  // compact JSON of responseBody map
    private String constraints;
    private String rawModelOutput;
    private String errorMessage;
    /**
     * JSON array string of pre-seeded test cases generated by Mistral or the dynamic fallback.
     * Format: [{"name":"...","description":"...","inputPayload":"...","expectedStatus":200,"expectedResponse":"..."}]
     */
    ...
    public String getRequestSpecification() { return requestSpecification; }
    public void setRequestSpecification(String requestSpecification) { this.requestSpecification = requestSpecification; }

    public String getResponseSpecification() { return responseSpecification; }
    public void setResponseSpecification(String responseSpecification) { this.responseSpecification = responseSpecification; }
    ...
    public String getTestCaseSeed() { return testCaseSeed; }
    public void setTestCaseSeed(String testCaseSeed) { this.testCaseSeed = testCaseSeed; }
}
