...
export const AiSummaryCard = ({ summary }: AiSummaryCardProps) => {
  return (
    <div className="bg-purple-50/40 border border-purple-200/70 rounded-2xl p-6 shadow-sm space-y-3">
      {/* Header */}
      <div className="flex items-center gap-2 text-purple-700">
        <div className="w-7 h-7 rounded-lg bg-purple-100 flex items-center justify-center text-purple-600">
          <Sparkles className="w-4 h-4" />
        </div>
        <h3 className="font-bold text-sm text-purple-900 tracking-tight">
