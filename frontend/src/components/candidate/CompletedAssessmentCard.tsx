...
export const CompletedAssessmentCard = ({
  ...
  return (
    <div className="bg-white rounded-3xl border border-gray-200/90 p-6 sm:p-7 shadow-2xs hover:shadow-md hover:border-emerald-200 transition-all flex flex-col justify-between space-y-6">
      {/* Top Header */}
      ...
      <div className="pt-2 border-t border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Link to={`/dashboard/candidates/${assessment.id}`}>
          <Button
            size="sm"
            variant="outline"
            className="w-full sm:w-auto font-semibold text-xs gap-1.5 border-gray-300 hover:bg-gray-50 shadow-2xs"
          >
